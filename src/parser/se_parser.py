...
class SEParser:
    ...
    def _require_ascii_digits(name: str, value: object, width: int) -> None:
        if (
            ...
            raise RecordValidationError(
                ...
                record_type="SE", field_name=name, value=value,
            )
    ...
    def validate_key_fields(cls, record: Mapping[str, object]) -> None:
        ...
        for name, width in (
            ...
            cls._require_ascii_digits(name, record.get(name), width)
        ...
        for field_name, byte_width in cls.BODY_FIELD_BYTE_WIDTHS:
            ...
            if len(encoded) > byte_width:
                raise RecordValidationError(
                    ...
                    field_name=field_name,
                    value=value,
                    expected=f"at most {byte_width} CP932 bytes",
                )

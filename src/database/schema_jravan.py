...
JRAVAN_SCHEMAS: Dict[str, str] = {
    ...
    "TENKO_BABA": """
        CREATE TABLE IF NOT EXISTS TENKO_BABA (
            ...
            Nichiji                        SMALLINT NOT NULL   ,  -- 開催日目
            HappyoTime                     VARCHAR(8) NOT NULL,  -- 発表月日時分(MMDDhhmm)
            HenkoID                        VARCHAR(1) NOT NULL,  -- 文字列(1)
    ...
    "UMA": """
        CREATE TABLE IF NOT EXISTS UMA (
            ...
            MakeDate                       DATE NOT NULL       ,  -- YYYYMMDD形式の日付
            KettoNum                       VARCHAR(10) NOT NULL ,  -- 血統登録番号
            DelKubun                       VARCHAR(1) NOT NULL ,  -- 文字列(1)
            RegDate                        VARCHAR(8) NOT NULL ,  -- 文字列(8)
            DelDate                        VARCHAR(8) NOT NULL ,  -- 抹消年月日（00000000を保持）
            BirthDate                      DATE NOT NULL       ,  -- 生年月日
            Bamei                          VARCHAR(36) NOT NULL ,  -- 文字列(36)
            BameiKana                      VARCHAR(36) NOT NULL ,  -- 文字列(36)
            BameiEng                       VARCHAR(60) NOT NULL ,  -- 文字列(60)
            ZaikyuFlag                     VARCHAR(1) NOT NULL ,  -- 文字列(1)
            Reserved                       VARCHAR(19) NOT NULL ,  -- 文字列(19)
            UmaKigoCD                      VARCHAR(2) NOT NULL ,  -- 文字列(2)
            SexCD                          VARCHAR(1) NOT NULL ,  -- 文字列(1)
            HinsyuCD                       VARCHAR(1) NOT NULL ,  -- 文字列(1)
            KeiroCD                        VARCHAR(2) NOT NULL ,  -- 文字列(2)
            Ketto3InfoHansyokuNum1         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei1               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum2         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei2               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum3         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei3               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum4         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei4               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum5         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei5               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum6         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei6               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum7         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei7               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum8         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei8               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum9         VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei9               VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum10        VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei10              VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum11        VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei11              VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum12        VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei12              VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum13        VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei13              VARCHAR(36) NOT NULL ,  -- 文字列(36)
            Ketto3InfoHansyokuNum14        VARCHAR(10) NOT NULL ,  -- 文字列(10)
            Ketto3InfoBamei14              VARCHAR(36) NOT NULL ,  -- 文字列(36)
            TozaiCD                        VARCHAR(1) NOT NULL ,  -- 文字列(1)
            ChokyosiCode                   VARCHAR(5) NOT NULL ,  -- 文字列(5)
            ChokyosiRyakusyo               VARCHAR(8) NOT NULL ,  -- 文字列(8)
            Syotai                         VARCHAR(20) NOT NULL ,  -- 文字列(20)
            BreederCode                    VARCHAR(8) NOT NULL ,  -- 文字列(8)
            BreederName                    VARCHAR(72) NOT NULL ,  -- 文字列(72)
            SanchiName                     VARCHAR(20) NOT NULL ,  -- 文字列(20)
            BanusiCode                     VARCHAR(6) NOT NULL ,  -- 文字列(6)
            BanusiName                     VARCHAR(64) NOT NULL ,  -- 文字列(64)
            RuikeiHonsyoHeiti              VARCHAR(9) NOT NULL ,  -- 文字列(9)
            RuikeiHonsyoSyogai             VARCHAR(9) NOT NULL ,  -- 文字列(9)
            RuikeiFukaHeichi               VARCHAR(9) NOT NULL ,  -- 文字列(9)
            RuikeiFukaSyogai               VARCHAR(9) NOT NULL ,  -- 文字列(9)
            RuikeiSyutokuHeichi            VARCHAR(9) NOT NULL ,  -- 文字列(9)
            RuikeiSyutokuSyogai            VARCHAR(9) NOT NULL ,  -- 文字列(9)
            SogoChakukaisu1                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            SogoChakukaisu2                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            SogoChakukaisu3                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            SogoChakukaisu4                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            SogoChakukaisu5                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            SogoChakukaisu6                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            ChuoChakukaisu1                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            ChuoChakukaisu2                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            ChuoChakukaisu3                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            ChuoChakukaisu4                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            ChuoChakukaisu5                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            ChuoChakukaisu6                VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba1Chakukaisu1                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba1Chakukaisu2                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba1Chakukaisu3                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba1Chakukaisu4                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba1Chakukaisu5                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba1Chakukaisu6                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba2Chakukaisu1                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba2Chakukaisu2                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba2Chakukaisu3                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba2Chakukaisu4                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba2Chakukaisu5                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba2Chakukaisu6                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba3Chakukaisu1                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba3Chakukaisu2                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba3Chakukaisu3                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba3Chakukaisu4                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba3Chakukaisu5                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba3Chakukaisu6                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba4Chakukaisu1                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba4Chakukaisu2                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba4Chakukaisu3                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba4Chakukaisu4                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba4Chakukaisu5                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba4Chakukaisu6                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba5Chakukaisu1                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba5Chakukaisu2                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba5Chakukaisu3                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            Ba5Chakukaisu4                 VARCHAR(3) NOT NULL ,  -- 文字列(3)
            
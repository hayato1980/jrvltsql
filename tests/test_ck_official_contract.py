...
def test_ck_metadata_defects_fail_before_replacing_a_complete_row(tmp_path, defect) -> None:
...
def test_ck_sqlite_disabled_foreign_keys_fail_before_parent_mutation(tmp_path) -> None:
...
def test_ck_postgresql_complete_roundtrip_reconnect_update_delete(postgresql_db) -> None:
